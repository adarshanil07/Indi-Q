...
const RULES = [
  ...
  { heading: 'Timer', body: 'The countdown starts as soon as you reveal the card. When it hits zero, the cards are hidden again and you have a brief moment to log any last second correct guess before confirming the end of the round.' },
  { heading: 'Chakra Round', body: 'Instead of a normal turn, the active team can start a Chakra Round. The describer picks one of several cards and describes its Chakra word (marked with the ☸ symbol) while every team guesses. The first team to guess it wins bonus points or an extra round.' },
